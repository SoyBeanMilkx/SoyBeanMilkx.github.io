...
// Function to copy code to clipboard
  function copyToClipboard(block) {
    ...
    navigator.clipboard.writeText(text).then(() => {
      ...
      showPopup("Code copied to clipboard!", 2000);
    }).catch(err => {
...
// Function to create and show the popup
  function showPopup(message, duration) {
    ...
    popup.style.backgroundColor = '#376414';
    ...
    popup.style.transition = 'opacity 0.5s ease, top 0.5s ease';
    ...
    setTimeout(() => {
      ...
      popup.style.top = '20px'; // Adjust to the desired distance from the top
    }, 100); // Delay to ensure the transition effect works
